<template>
  <div class="p-4 md:p-8 max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      <div>
        <div class="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-zinc-100 text-zinc-700 text-xs font-semibold mb-2">
        ...
        <div class="p-5 flex-1 flex flex-col justify-between space-y-4">
          ...
          <div class="pt-3 border-t border-zinc-100 flex items-center justify-between">
            ...
            <button
              ...
              class="p-2 rounded-full hover:bg-zinc-100 text-zinc-500 hover:text-zinc-900 transition-colors"
