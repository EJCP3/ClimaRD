...
const alertShape = computed(() => { if (!province.value) return 'circle'; switch (province.value.alerta) { case 'ROJA': return 'burst'; case 'AMARILLA': return '12-sided-cookie'; case 'VERDE': return 'flower-8'; default: return 'circle' } })
