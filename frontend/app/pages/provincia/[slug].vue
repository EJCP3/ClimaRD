...
const alertBadgeClass = computed(() => { if (!province.value) return ''; switch (province.value.alerta) { case 'ROJA': return 'bg-[#EF4444]'; case 'AMARILLA': return 'bg-[#FACC15] !text-zinc-950'; case 'VERDE': return 'bg-[#22C55E]'; default: return 'bg-zinc-400' } })
